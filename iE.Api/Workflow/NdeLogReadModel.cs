...
public sealed class DemoNdeLogReadModelService : INdeLogReadModelService
{
    ...
    [
        ...
        new("nde-005", NdeNumbering.FormatRequestNumber(DemoYear, 5), null, "CIR-3C-118", null, "PMI", NdeLogStatuses.ResultsReceived, "High", "G. Martin", "V. Chen", "2026-05-10", "2026-05-09", NdeReportStatuses.InProgress, NdeNumbering.FormatReportNumber(DemoYear, "PMI", 5), null, null, "Platform"),
        new("nde-006", NdeNumbering.FormatRequestNumber(DemoYear, 6), null, null, "TK-804", "PAUT", NdeLogStatuses.Reviewed, "Normal", "P. Singh", "N. Brooks", "2026-05-09", "2026-05-08", NdeReportStatuses.Complete, NdeNumbering.FormatReportNumber(DemoYear, "PAUT", 6), "RPT-26-PAUT-006.pdf", "/demo-downloads/RPT-26-PAUT-006.pdf", "Ladder"),
