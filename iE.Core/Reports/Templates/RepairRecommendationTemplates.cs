    ...
    private static ReportTemplate Create(string id, string name, string standard, string assetLabel, string description) => new()
    {
        ...
        [
            ...
            CommonTemplateSections.CreateSection("asset-location", "Asset / Location", 2, false,
                CommonTemplateSections.Field("location", "Location", "text", true, "Use specific coordinates such as circuit/line segment, nozzle ID, shell course, or elevation."),
                CommonTemplateSections.Field("system-boundary", "System Boundary/Description", "textarea", false, "Define isolation limits or affected boundary for safe repair planning.")),
            CommonTemplateSections.CreateSection("condition-requiring-repair", "Condition Requiring Repair", 3, false,
                CommonTemplateSections.Field("description-condition", "Description of Condition", "textarea", true, "Include measured thicknesses, leak status, crack length, or deformation extent when available."),
                CommonTemplateSections.Field("damage-mechanism", "Damage Mechanism (if known)", "text", false, "Examples: CUI, external corrosion, erosion/corrosion, fatigue, settlement.")),
            CommonTemplateSections.CreateSection("recommended-repair", "Recommended Repair", 4, false,
                CommonTemplateSections.Field("recommended-repair-action", "Recommended Repair Action", "textarea", true, "State repair method, code/standard basis, and any required hold points.")),
            ...
            CommonTemplateSections.CreateSection("nde-verification", "NDE / Verification Requirements", 6, false,
                ...
                CommonTemplateSections.Field("pressure-leak-test-required", "Pressure/Leak Test Required", "boolean", false, "Indicate if post-repair leak/pressure test is mandatory before return to service."),
                CommonTemplateSections.Field("verification-notes", "Verification Notes", "textarea", false, "Capture acceptance criteria, coverage, and documentation required for closeout.")),
