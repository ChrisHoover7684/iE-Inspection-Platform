...
describe('App routes', () => {
  ...
  it('opens new NDE request modal and creates PT scope item request with searchable scope text', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Inspection Details'), { target: { value: 'Include root pass and final cap indications' } });
    ...
    fireEvent.change(screen.getByPlaceholderText('Search request #, asset, method, inspection details, or assignee'), { target: { value: 'hydrotest' } });
