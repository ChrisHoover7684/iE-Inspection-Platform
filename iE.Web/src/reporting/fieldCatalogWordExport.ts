...
<w:p><w:r><w:t xml:space="preserve">${esc(`Component Availability Metadata:\nEquipment Family|Equipment Subtype|Component|Requirement Level|Default Selected|Parent Component Required|Allowed Parent Components|Pressure Boundary Side|Design Pressure Field Tag|Design Temperature Field Tag|Supports Tmin Calculation|Tmin Calculation Method|Supports Nozzle UG-45|Review Notes\n${componentAvailabilityMetadata}`)}</w:t></w:r></w:p>
